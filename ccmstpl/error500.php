...
<html lang="<?=$CLEAN["ccms_lng"];?>">
	<head>
		<meta charset="utf-8">
		<title>500 ERROR | <?=$CFG["DOMAIN"];?></title>
	...
	<body>
		...
		<p>
			...
			/ <span style="border-bottom:1px dotted #ec7f27;">500 ERROR</span>
		</p>
		<div style="float:left; width:300px;">
			<h3 style="margin-top:0px;">500 ERROR:</h3>
			<p style="color:red; word-break: break-all;"><?=htmlspecialchars($_SERVER["REQUEST_URI"]);?> internal server error.  A generic error message, given when no more specific message is suitable.</p>
