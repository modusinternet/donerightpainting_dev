...
<html lang="<?=$CLEAN["ccms_lng"];?>">
	<head>
		<meta charset="utf-8">
		<title>403 ERROR | <?=$CFG["DOMAIN"];?></title>
	...
	<body>
		...
		<p>
			...
			/ <span style="border-bottom:1px dotted #ec7f27;">403 ERROR</span>
		</p>
		<div style="float:left; width:300px;">
			<h3 style="margin-top:0px;">403 ERROR:</h3>
			<p style="color:red; word-break: break-all;"><?=htmlspecialchars($_SERVER["REQUEST_URI"]);?> not found.  The request was a legal request, but the server is refusing to respond to it.</p>
