...
<html lang="<?=$CLEAN["ccms_lng"];?>">
	<head>
		<meta charset="utf-8">
		<title>404 ERROR | <?=$CFG["DOMAIN"];?></title>
	...
	<body>
		...
		<div style="float:left; width:300px;">
			...
			<p style="color:red; word-break: break-all;"><?=htmlspecialchars($_SERVER["REQUEST_URI"]);?> not found.  The requested page could not be found but may be available again in the future.</p>
