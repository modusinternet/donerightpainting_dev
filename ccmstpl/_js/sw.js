...
const cacheName = 'en-2021-02-17.v01';
...
var cacheFiles = [
	...
	'/en/manifest.html',
	'{CCMS_LIB:site.php;FUNC:load_resource("AWS")}/ccmstpl/_img/logo.webp',
	'{CCMS_LIB:site.php;FUNC:load_resource("AWS")}/ccmstpl/_img/logo.png',
	'{CCMS_LIB:site.php;FUNC:load_resource("AWS")}/ccmstpl/_img/logo2.webp',
	...
	*/
	...
	'{CCMS_LIB:site.php;FUNC:build_js_link("","","GDPR-JS")}'
];
