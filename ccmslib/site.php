...
function csp_header() {
	...
	$CFG["csp"] = "Content-Security-Policy: ".
		...
		"connect-src 'self' https: *.cloudfront.net *.doubleclick.net *.google.com *.googleapis.com *.googletagmanager.com *.google-analytics.com *.gstatic.com; ".
	...
	// Defines valid sources of Inline JavaScript.  Not supported by Firefox as of Oct 24, 2020 but may be useful in the future.
	$CFG["csp"] .= "script-src-attr 'strict-dynamic' 'nonce-" . $CFG["nonce"] . "';";
